...
public class SrvOrDistItemize extends BaseActivity implements AdapterView.OnItemClickListener {

    private static final String TAG = "SummaryServiceItemize";
    private ListView lv_ItemSummary;
    private Button btn_home;
    private Button btn_summaryMenu;
    private final Context mContext = SrvOrDistItemize.this;
    ...
    private void setUpGoBackButton() {
        ...
        btn_summaryMenu.setCompoundDrawablesRelativeWithIntrinsicBounds(null, imageGoto, null, null);
        btn_summaryMenu.setPadding(-1, 15, -1, 15);
    }
    @TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR1)
...
//        Log.i(TAG, "You clicked Item: " + id + " at position:" + position);
        ...
        Intent iItemSpecAttendance = new Intent(mContext, SrvOrDistItemizeAttendance.class);
